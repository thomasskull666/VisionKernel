...
# Destory 20-scheduler, put in the new one for BFQ by default

rm -rf /system/etc/init.d/20-scheduler
busybox cp /sbin/20-scheduler /system/etc/init.d/20-scheduler
